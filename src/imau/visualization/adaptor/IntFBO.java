...
public class IntFBO {
    ...
    private final IntRBOTexture rboTexture;

    private final int           width, height;
    private boolean             initialized = false;

    public IntFBO(int width, int height, int glMultitexUnit) {
        this.width = width;
        this.height = height;
        ...
        rboTexture = new IntRBOTexture(width, height, glMultitexUnit);
    }
    ...
    public IntTexture2D getTexture() {
        return rboTexture;
    }
