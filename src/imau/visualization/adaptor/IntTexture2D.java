...
public class IntTexture2D extends Texture {
    ...
    public IntTexture2D(int glMultitexUnit) {
    ...
    public IntTexture2D copy(GL3 gl, int glMultitexUnit) {
        IntTexture2D result = new IntTexture2D(glMultitexUnit);
